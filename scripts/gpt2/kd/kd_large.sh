...
CKPT="/root/autodl-tmp/model/hub/models--openai-community--gpt2-xl/snapshots/15ea56dee5df4983c59b2538573817e1667135e2"
...
TYPE=kd
# runtime
SAVE_PATH="/root/autodl-tmp/save/results/gpt2/train/${TYPE}/${CKPT_NAME}-ratio0.5"
