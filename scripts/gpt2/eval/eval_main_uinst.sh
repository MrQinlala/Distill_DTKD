...
CKPT="/root/autodl-tmp/save/results/gpt2/train/akl/gpt2-base-final2/12500"
# data
# data
DATA_NAMES="uinst"
DATA_DIR="${BASE_PATH}/data/uinst"
# hp
EVAL_BATCH_SIZE=8
# runtime
SAVE_PATH="/root/autodl-tmp/save/results/gpt2/eval_main/akl/${CKPT_NAME}-final2/${DATA_NAMES}"
TYPE="eval_main"
